...
auto PCEngine::heuristics(vector<uint8_t>& data, string location) -> string {
  ...
  //PC Engine
  if(digest == "afe9f27f91ac918348555b86298b4f984643eafa2773196f2c5441ea84f0c3bb") board = "System Card 1.00", region = "NTSC-J";
  if(digest == "909f2153e624b76392684434ba5aa3e394cbba0318a0dda350140cb61ce9bc49") board = "System Card 2.00", region = "NTSC-J";
  if(digest == "0deb13845c7e44ea78a25bbbe324afd60a0ec29ea5a4cf5780349f1598d24cd3") board = "System Card 2.10", region = "NTSC-J";
  if(digest == "e11527b3b96ce112a037138988ca72fd117a6b0779c2480d9e03eaebece3d9ce") board = "System Card 3.00", region = "NTSC-J";

  //TurboGrafx
  if(digest == "edba5be43803b180e1d64ca678c3f8bdbf07180c9e2a65a5db69ad635951e6cc") board = "System Card 2.00", region = "NTSC-U";
  if(digest == "cadac2725711b3c442bcf237b02f5a5210c96f17625c35fa58f009e0ed39e4db") board = "System Card 3.00", region = "NTSC-U";
