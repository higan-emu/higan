...
void main() {
//motion blur
vec3 color = pow(texture(history[7], texCoord).rgb, vec3(gamma));
color = (color + pow(texture(history[6], texCoord).rgb, vec3(gamma))) / 2.0;
color = (color + pow(texture(history[5], texCoord).rgb, vec3(gamma))) / 2.0;
color = (color + pow(texture(history[4], texCoord).rgb, vec3(gamma))) / 2.0;
color = (color + pow(texture(history[3], texCoord).rgb, vec3(gamma))) / 2.0;
color = (color + pow(texture(history[2], texCoord).rgb, vec3(gamma))) / 2.0;
color = (color + pow(texture(history[1], texCoord).rgb, vec3(gamma))) / 2.0;
color = (color + pow(texture(history[0], texCoord).rgb, vec3(gamma))) / 2.0;
color = (color + pow(texture(source[0], texCoord).rgb, vec3(gamma))) / 2.0;
  vec4 rgba = vec4(pow(color, 1.0 / vec3(gamma)), 1.0);
