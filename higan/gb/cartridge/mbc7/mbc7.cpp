...
auto Cartridge::MBC7::read(uint16 address) -> uint8 {
  ...
  if((address & 0xf000) == 0xa000) {  //$a000-afff
    ...
    switch(address(4,7)) {
    case 2: return io.accelerometer.x(0, 7);
    case 3: return io.accelerometer.x(8,15);
    case 4: return io.accelerometer.y(0, 7);
    case 5: return io.accelerometer.y(8,15);
