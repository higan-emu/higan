...
auto WDC65816::disassemble(uint24 address, bool e, bool m, bool x) -> string {
  ...
  auto opcode   = read(address); address.range(0,15)++;
  auto operand0 = read(address); address.range(0,15)++;
  auto operand1 = read(address); address.range(0,15)++;
  auto operand2 = read(address); address.range(0,15)++;
