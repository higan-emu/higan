...
void main() {
	//Declare parameters
	//pixelSize
	vec4 c0 = sourceSize[0].xyzw;
	//textureSize
	vec4 c1 = sourceSize[0].xyzw;
	//viewSize
	vec4 c2 = targetSize.xyzw;
	//texDiffuse
	...
	r3 = r2.xyxy * r3;
	r5 = r2.xyxy * r5;
	r6 = texture(source[0], r5.zw);
	r5 = texture(source[0], r5.xy);
	...
	r7 = r2.xyxy * r7;
	r2 = r2.xyxy * r6;
	r6 = texture(source[0], r2.zw);
	r2 = texture(source[0], r2.xy);
	...
	r6 = texture(source[0], r3.xy);
	r3 = texture(source[0], r3.zw);
	...
	r5 = texture(source[0], r4.xy);
	r4 = texture(source[0], r4.zw);
	...
	r3 = texture(source[0], r7.xy);
	r5 = texture(source[0], r7.zw);
